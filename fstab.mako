...
/dev/block/platform/msm_sdcc.1/by-name/cache	    /cache		    f2fs    noatime,nosuid,nodev,discard,inline_xattr                       wait,check
/dev/block/platform/msm_sdcc.1/by-name/cache        /cache          ext4    noatime,nosuid,nodev,barrier=1,data=ordered                     wait,check
/dev/block/platform/msm_sdcc.1/by-name/userdata     /data           f2fs    noatime,nosuid,nodev,discard,nodiratime,inline_xattr,flush_merge,errors=recover     wait,check,encryptable=/dev/block/platform/msm_sdcc.1/by-name/metadata
